...
class TestFunction(unittest.TestCase):
    ...
    #make sure that example1 and example 2 aren't friends already in the db
    def test_1(self):
        payload = {"email1": "example1@example.com", "password": "12345678", "email2" : "example2@example.com"}


        resp = requests.get(
                'http://localhost:7071/api/user/addfriend', 
                json = payload)
    ...
    def test_3(self):
        payload = {"email1": "example1@example.com", "password": "12345678", "email2" : "doesnotexist@example.com"}
    ...
    def test_4(self):
        payload = {"email1": "doesnotexist@example.com", "password": "12345678", "email2" : "example2@example.com"}
