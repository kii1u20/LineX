...
class TestFunction(unittest.TestCase):
    ...
    def test_correctId(self):
        payload = {"id" : "a05563ba-707c-4bab-b099-bb8be503ef82", "users": ["dr5g20@soton.ac.uk"]}

        resp = requests.get(
                'http://localhost:7071/api/UpdateEventParticipants', 
                json = payload)
    ...
    def test_nonExistingId(self):
        payload = {"id" : "a05563ba-707c-4bab-b099-bb8be503ef8211", "users": ["dr5g20@soton.ac.uk"]}
