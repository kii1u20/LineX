...
def main(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Updating suggestion votes...')
    ...
    eventId = event['id']
    eventSuggestionID = event['suggestion']
    ...
    try:
        ...
        if len(results)==0:
            ...
            for suggestion in eventContent['suggestions']:
                if suggestion['id'] == eventSuggestionID:
                    logging.info('success')
                    suggestion['content']['votes'] = suggestion['content']['votes'] + 1
