...
def main(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Updating event users voted...')
    ...
    try:
        ...
        if len(results)==0:
            ...
            if userEmail in eventContent['usersVoted']:
                return func.HttpResponse(body=json.dumps({"result": False , "message": "The user has already voted"}), status_code=400)
            eventContent['usersVoted'].append(userEmail)
